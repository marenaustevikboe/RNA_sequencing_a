...
#I did the GSEA filtering for small gene set size, between 10 an 25
...
gsea_results <- GSEA(
  ...
  maxGSSize = 25, # Maximum gene set set
...
readr::write_tsv(
  ...
  file.path(
    "Results",
    "SRP123625_gsea_curated_small_geneSetSize_results.tsv"
  )
)
